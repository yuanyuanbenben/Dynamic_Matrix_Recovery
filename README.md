...
<details>
 ...
 in terminal is enough and results will be saved in the output files "<strong><em>output/baseline_120000.csv"</em></strong>" and "<strong><em>output/baseline_120000.csv"</em></strong>".
        </li> 
