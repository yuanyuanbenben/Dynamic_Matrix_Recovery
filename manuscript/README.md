...
- "***netflix_mse(sample).png***": The $\text{MSE}_t$ for Filter 1(2) at differnet time points for DLR and three benchmarks, which corresponds to *Figure 5* in the main context.
